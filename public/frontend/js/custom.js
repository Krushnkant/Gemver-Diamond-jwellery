...
$(document).ready(function() {
    ...
    // $(".shop-dimond-by-shape-slider > .owl-nav >  .owl-prev").html('<i class="fa-solid fa-chevron-left"></i>');
    // $(".shop-dimond-by-shape-slider > .owl-nav > .owl-next").html('<i class="fa-solid fa-chevron-right"></i>');
    // $(".Instagram-post-slider > .owl-nav >  .owl-prev").html('<i class="fa-solid fa-chevron-left"></i>');
    // $(".Instagram-post-slider > .owl-nav > .owl-next").html('<i class="fa-solid fa-chevron-right"></i>');
    // $(".shop-by-category > .owl-nav >  .owl-prev").html('<i class="fa-solid fa-chevron-left"></i>');
    // $(".shop-by-category > .owl-nav > .owl-next").html('<i class="fa-solid fa-chevron-right"></i>');
    // $(".product-detail > .owl-nav >  .owl-prev").html('<i class="fa-solid fa-chevron-left"></i>');
    // $(".product-detail > .owl-nav > .owl-next").html('<i class="fa-solid fa-chevron-right"></i>');
