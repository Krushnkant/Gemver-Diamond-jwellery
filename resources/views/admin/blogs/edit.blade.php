<form class="form-valide" action="" id="BlogCreateForm" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <textarea class="" id="description" name="description">{!! $blog->description !!}</textarea>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-12">
            <div class="input-group mb-2">
                ...
                <input type="text" id="slug" class="form-control input-default" name="slug" value="{{ isset($blog)?($blog->slug):'' }}">
              </div>
