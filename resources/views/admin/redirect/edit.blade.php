<form class="form-valide" action="" id="redirectForm" method="post">
    ...
    <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12 container justify-content-center">
        ...
        <button type="button" class="btn btn-outline-primary" id="save_newredirectBtn" data-action="update">Save & New <i class="fa fa-circle-o-notch fa-spin loadericonfa" style="display:none;"></i></button>&nbsp;&nbsp;
        <button type="button" class="btn btn-primary" id="save_closeredirectBtn" data-action="update">Save & Close <i class="fa fa-circle-o-notch fa-spin loadericonfa" style="display:none;"></i></button>
