                ...
                <div class="row">
                    ...
                    <!-- <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <img src="@if(isset($step) && !empty($step->step3_icon))  {{ url('images/steps/'.$step->step3_icon) }} @else {{ asset('images/default_avatar.jpg') }} @endif" class="" id="step3_icon_show" height="250px" width="250px" style="margin-top: 5px">
                        </div>
                    </div> -->
                    ...
                    <!-- <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <img src="@if(isset($step) && !empty($step->step3_header_image))  {{ url('images/steps/'.$step->step3_header_image) }} @else {{ asset('images/default_avatar.jpg') }} @endif" class="" id="step3_header_image_show" height="250px" width="250px" style="margin-top: 5px">
                        </div>
                    </div> -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <img src="@if(isset($step) && !empty($step->step3_section2_image))  {{ url('images/steps/'.$step->step3_section2_image) }} @else {{ asset('images/default_avatar.jpg') }} @endif" class="" id="step3_section2_image_show" height="250px" width="250px" style="margin-top: 5px">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <img src="@if(isset($step) && !empty($step->step3_section3_image))  {{ url('images/steps/'.$step->step3_section3_image) }} @else {{ asset('images/default_avatar.jpg') }} @endif" class="" id="step3_section3_image_show" height="250px" width="250px" style="margin-top: 5px">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <img src="@if(isset($step) && !empty($step->step3_section4_image))  {{ url('images/steps/'.$step->step3_section4_image) }} @else {{ asset('images/default_avatar.jpg') }} @endif" class="" id="step3_section4_image_show" height="250px" width="250px" style="margin-top: 5px">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <img src="@if(isset($step) && !empty($step->step3_section5_image))  {{ url('images/steps/'.$step->step3_section5_image) }} @else {{ asset('images/default_avatar.jpg') }} @endif" class="" id="step3_section5_image_show" height="250px" width="250px" style="margin-top: 5px">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <img src="@if(isset($step) && !empty($step->step3_section6_image))  {{ url('images/steps/'.$step->step3_section6_image) }} @else {{ asset('images/default_avatar.jpg') }} @endif" class="" id="step3_section6_image_show" height="250px" width="250px" style="margin-top: 5px">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <img src="@if(isset($step) && !empty($step->step3_section8_image))  {{ url('images/steps/'.$step->step3_section8_image) }} @else {{ asset('images/default_avatar.jpg') }} @endif" class="" id="step3_section8_image_show" height="250px" width="250px" style="margin-top: 5px">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <img src="@if(isset($step) && !empty($step->step3_section9_image))  {{ url('images/steps/'.$step->step3_section9_image) }} @else {{ asset('images/default_avatar.jpg') }} @endif" class="" id="step3_section9_image_show" height="250px" width="250px" style="margin-top: 5px">
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <img src="@if(isset($step) && !empty($step->step3_section10_image))  {{ url('images/steps/'.$step->step3_section10_image) }} @else {{ asset('images/default_avatar.jpg') }} @endif" class="" id="step3_section10_image_show" height="250px" width="250px" style="margin-top: 5px">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <img src="@if(isset($step) && !empty($step->step3_section11_image))  {{ url('images/steps/'.$step->step3_section11_image) }} @else {{ asset('images/default_avatar.jpg') }} @endif" class="" id="step3_section11_image_show" height="250px" width="250px" style="margin-top: 5px">
                        </div>
                    </div>
