    ...
    <div class="row"> 
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_title">Step 4 Title <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_shotline">Step 4 Shotline <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section1_title">Section 1 Title <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section1_description">Section 1 Description <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section2_title">Section 2 Title <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section2_description">Section 2 Description <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section2_image">Section 2 Image  <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section3_title">Section 3 Title <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section3_description">Section 3 Description <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section3_image">Section 3 Image  <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section4_title">Section 4 Title <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section4_description">Section 4 Description <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section5_title">Section 5 Title <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section5_description">Section 5 Description <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section5_image">Section 5 Image  <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section6_title">Section 6 Title <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section6_description">Section 6 Description <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section7_title">Section 7 Title <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section7_description">Section 7 Description <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section8_title">Section 8 Title <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section8_description">Section 8 Description <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section9_title">Section 9 Title <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section9_description">Section 9 Description <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section9_image">Section 9 Image  <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section10_title">Section 10 Title <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section10_description">Section 10 Description <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section11_title">Section 11 Title <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section11_image1">Section 11 Image1  <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section11_title1">Section 11 Title1 <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section11_image2">Section 11 Image2  <span class="text-danger">*</span>
                </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label class="col-form-label" for="step4_section11_title2">Section 11 Title2 <span class="text-danger">*</span>
                </label>
