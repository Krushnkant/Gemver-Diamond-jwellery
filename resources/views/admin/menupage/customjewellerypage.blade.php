    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Custom Made Jewellery Page</a></li>
            </ol>
        </div>
    </div>
    <!-- row -->
...
<script type="text/javascript">
    ...
    $('body').on('click', '#saveMenuPage', function () {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ url('admin/updateCustomJewelleryPage') }}",
            data: formData,
            processData: false,
            contentType: false,
            success: function (res) {
                ...
                if(res.status == 200){
                    ...
                    toastr.success("Custom Made Jewellery Page Updated",'Success',{timeOut: 5000});
                }
