    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Engagement Page</a></li>
            </ol>
        </div>
    </div>
    <!-- row -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="row col-lg-12">
                            ...
                            <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12  justify-content-center">
                             ...
                             <div class="form-group">
                                <label class="col-form-label" for="section1_button_title">Button Title
                                </label>
                                <input type="text" class="form-control input-flat" id="section1_button_title" name="section1_button_title" >
                                <div id="section1_button_title-error" class="invalid-feedback animated fadeInDown" style="display: none;"></div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12  justify-content-center">
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    <label class="col-form-label" for="section1_button_url">Button URL 
                                    </label>
                                    <input type="text" class="form-control input-flat" id="section1_button_url" name="section1_button_url" >
                        ...
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12  justify-content-center">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control input-flat" id="section4_button_title" name="section4_button_title" >
                                <div id="section1_button_title-error" class="invalid-feedback animated fadeInDown" style="display: none;"></div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12  justify-content-center">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-flat" id="section4_button_url" name="section4_button_url" >
                                <div id="section1_button_url-error" class="invalid-feedback animated fadeInDown" style="display: none;"></div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12  justify-content-center">
...
<script type="text/javascript">
    $( document ).ready(function() {
        ...
        $.get("{{ url('admin/menupage') }}" +'/1/edit', function (data) {
           ...
           $('#section1_button_url').val(data.section1_button_url);
           ...
           $('#section4_button_title').val(data.section4_button_title);
           $('#section4_button_url').val(data.section4_button_url);
    ...
    $('body').on('click', '#Add', function(){    
      ...
      html += '<div class="row col-lg-12"><div class="col-lg-2 ">'+
        ...
        '</div>'+
        '<div class="col-md-2">'+
            '<button type="button"  class="minus_btn btn mb-1 btn-outline-danger" ><i class="fa fa-remove"></i>'+
        '</div>'+
        '</div></div>';
