                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <input type="hidden" id="categoryIds" name="categoryIds"
                            value="{{ isset($product->primary_category_id) ? ($product->primary_category_id) : ($product->primary_category_id) }}">
                        <input type="hidden" id="childCategoryId" name="childCategoryId"
                            value="{{ isset($product->primary_category_id) ? $product->primary_category_id: '' }}">
                        <input type="hidden" id="attrid_for_variation" name="attrid_for_variation"
                            value="{{ $product->attrid_for_variation }}">
                        <input type="hidden" id="attr_term_ids" name="attr_term_ids"
                            value="{{ $product->attr_term_ids }}">
                        ...
                        <?php  
                            ...
                            ?>
                        <input type="hidden" id="term_no" name="term_no" value="{{ ($term_no!='')?$term_no:0 }}">
                        <input type="hidden" id="attributes_no" name="attributes_no"
                            value="{{ ($attributes_no!='')?$attributes_no:0 }}">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group category">
                                    ...
                                    <select id='category_id' name="category_id[]" class="form-control catMulti" id=""
                                        ...
                                        @foreach($catArray as $cat)
                                        <option value="<?php echo $cat['id']; ?>" @if(in_array($cat['id'],$categories))
                                            selected @endif>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" class="form-control input-default DesignNumber"
                                            id="DesignNumber" name="DesignNumber"
                                            value="{{ isset($product->design_number)?$product->design_number:'' }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" class="form-control input-default ProductName"
                                            ...
                                            value="{{ isset($product->product_title)?$product->product_title:'' }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12">
                                        <select class="form-control" id="sizechart" name="sizechart">
                                            ...
                                            <option value="{{ $sizechart->id }}" @if($product->sizechart_id ==
                                                $sizechart->id) selected @endif>{{ $sizechart->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="checkbox" name="is_custom" id="is_custom"
                                                        @if(isset($product) && ($product->is_custom == 1) ) checked
                                                    @endif class="form-check-input primaryBox" value="{{
                                                    isset($product)?($product->is_custom):0 }}">Do you want to add
...
<div class="col-lg-3 col-md-12">
    <div class="card">
        <div class="card-body">
            ...
            <textarea class="form-control input-default" name="notes" id="notes"
                rows="20">{{ isset($product->note)?$product->note:'' }}</textarea>
        </div>
    </div>
</div>
</div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group attribute">
                            <label class="col-form-label d-block" for="attribute_id"> Select Attribute <span
                                    class="text-danger">*</span>
                            </label>
                            <div class="row">
                                <div class="col-md-6">
                                    <select id='attribute_id' name="attribute_id" class="form-control attribute_id"
                                        id="">
                                        <option></option>
                                        <?php
                                        ...
                                        <option data-title="<?php echo $attr['attribute_name']; ?>"
                                            value="{{ $attr['id'] }}" @if(isset($product->product_attributes) &&
                                            in_array($attr['id'],$attribute_check)) disabled @endif>{{
                                ...
                                <div class="col-md-6">
                                    @if(count($product->product_attributes) > 0)
                                    <button type="button" class="AddSub btn  d-inline-block mb-3" data-id="1"
                                        style="background-color: #e7e7e7; color: black;" id="AddSub"
                                        style="display: none"> Add </button>
                                    @else
                                    <button type="button" class="AddSub btn  d-inline-block mb-3" data-id="0"
                                        style="background-color: #e7e7e7; color: black;" id="AddSub"
                                        style="display: none"> Add </button>
                                    @endif
                                </div>
                ...
                <div class="panel-group col-md-12">
                    <div class="row add-value-sub" id="attribute-data">
                        ...
                        <div id="" class="single-variation-box col-lg-6 col-md-12  col-xs-12 panel panel-default active"
                            data-term="{{ $attribute->attr_name }}">
                            <div class="variation-selection-box row panel-heading active">
                                <div class="col-lg-10 col-sm-8">
                                    <label class="col-form-label"><b><span class="VariantCnt">{{
                                                $attribute['attribute_name'] }} </span></b></label>
                                </div>
                                <div class="col-lg-2 col-sm-2 actionbox ml-auto text-right"><a role="button"
                                        class="collapse-arrow variantbox-collapse d-inline-block pr-4"
                                        data-toggle="collapse" href="#" aria-expanded="true"
                                        onclick="collapsePanel(this)"></a>
                            ...
                            <div id="" role="tabpanel" class="panel-collapse collapse show attribute-product-box">
                                <form method="post" enctype="multipart/form-data" class="attributeForm"
                                    id="attributeForm">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            <label class="col-lg-12 col-form-label" for="">{{
                                                $attribute['attribute_name'] }} <span
                                                    class="text-danger">*</span></label>
                                            <div class="col-lg-12">
                                                <select class="form-control Attribute" id=""
                                                    id-data="Attribute'.$required_variation['id'].'"
                                                    name="Attribute{{ $attribute['id'] }}[]" multiple>


                                                    @php
                                                    $terms =
                                                    \App\Models\AttributeTerm::where('attribute_id',$attribute['id'])->orderBy('sorting','asc')->get()->toArray();
                                                    $selectterms = explode(',',$product_attribute['terms_id']);
                                                    @endphp
                                                    @foreach($terms as $term)
                                                    <option value="{{ $term['id'] }}"
                                                        @if(in_array($term['id'],$selectterms)) selected @endif>{{
                                                        $term['attrterm_name'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <label id="Attribute{{ $attribute['id'] }}-error"
                                            class="error invalid-feedback animated fadeInDown" for=""></label>
                                    </div>
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-check">
                                                <input type="checkbox" class="avoid-clicks"
                                                    style="pointer-events: none;"
                                                    name="attribute_variation{{ $attribute['id'] }}"
                                                    @if(isset($product_attribute) && ($product_attribute->use_variation
                                                == 1) ) checked @endif ">
                                                <label class="form-check-label">
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-check">
                                                <input type="checkbox" class="check avoid-clicks"
                                                    style="pointer-events: none;"
                                                    name="use_comman{{ $attribute['id'] }}"
                                                    @if(isset($product_attribute) && ($product_attribute->use_comman ==
                                                1) ) checked @endif>
                ...
                <button type="button" class="save_attributes btn mt-3" style="background-color: #e7e7e7; color: black;"
                    id="save_attributes">Save attributes</button>
            ...
            <div class="card-body">
                ...
                <div class="panel-group col-md-12">
                    <div class="row variation-box" id="variant-data">
                        ...
                        <div id=""
                            class="single-variation-box col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 panel panel-default"
                            data-term="{{ $term->attrterm_name }}">
                            <div class="variation-selection-box row panel-heading active">
                                <div class="col-lg-10 col-sm-8">
                                    <label class="col-form-label"><b><span class="VariantCnt">{{ $term->attrterm_name
                                                }}</span></b></label>
                                </div>
                                <div class="col-lg-2 col-sm-2 actionbox ml-auto text-right"><a role="button"
                                        class="collapse-arrow variantbox-collapse d-inline-block pr-4"
                            ...
                            <div id="" role="tabpanel" class="panel-collapse collapse show variation-product-box">
                                <form method="post" enctype="multipart/form-data" class="variantForm" id="variantForm">
                                    ...
                                    @if(isset($required_vari_data['required_variations']) &&
                                    !empty($required_vari_data['required_variations']))
                                    <div class="row VariationSelect">
                                        <input type="hidden" name="comman_id" value="{{ $product_variant }}">
                                        <input type="hidden" name="varVariation" value="{{ implode("
                                            ,",$required_vari_data['required_variation_ids']) }}">
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-6 col-xs-12">
                                            <div class="form-group row">
                                                <label class="col-lg-12 col-form-label" for="VariationAttr">{{
                                                    $required_variation['attribute_name'] }} <span
                                                        class="text-danger">*</span></label>
                                                <div class="col-lg-12">
                                                    <select class="form-control Variation {{ $primaryclass }}" id=""
                                                        id-data="Variation{{ $required_variation['id'] }}"
                                                        name="Variation{{ $required_variation['id'] }}[]" multiple>
                                                        <option></option>
                                                        ...
                                                        <?php 
                                                                        ...
                                                                        ?>
                                                        <option value="{{ $term['id'] }}" @if(isset($variant_term) &&
                                                            in_array($term['id'], $variant_term) ) selected @endif>{{
                                                            $term['attrterm_name'] }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <label id="Variation{{ $required_variation['id'] }}-error"
                                                class="error invalid-feedback animated fadeInDown" for=""></label>
                                        </div>
                                        @endforeach

                                    </div>
                                    <button type="button" class="AddSubSub btn  d-inline-block mb-3"
                                        style="background-color: #e7e7e7; color: black;" id="AddSubSubEdit"
                                        style="display: none"> Add </button>
                                    @endif
                                    <?php 
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <input type="file" name="files[]" id="varImgFiles-{{ $term_item_id }}"
                                                multiple="multiple">
                                            <input type="hidden" name="varImage" id="varImage-{{ $term_item_id }}"
                                                class="varImg"
                                                value="{{ isset($variant_image['images']) ? $variant_image['images'] : '' }}">
                                            <label id="varImage-error"
                                                class="error invalid-feedback animated fadeInDown" for="varImage"
                                                ...
                                                <div class="jFiler-items jFiler-row oldImgDisplayBox">
                                                    <ul class="jFiler-items-list jFiler-items-grid">
                                                        <?php 
                                                                        ...
                                                                        if(isset($variant_image['images']) && $variant_image['images'] != ""){
                                                        ...
                                                        <li id="oldVarImgBox{{ $term_item_id }}-{{ $vcnt }}"
                                                            class="jFiler-item" data-jfiler-index="1" style="">
                                                            <div class="jFiler-item-container">
                                                                <div class="jFiler-item-inner">
                                                                    <div class="jFiler-item-thumb">
                                                                        <div class="jFiler-item-status"></div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="text"
                                                                            class="mt-2 form-control input-default"
                                                                            placeholder="Alter Text" name="alt_text[]"
                                                                            style="width: 85px;font-size: 12px; height:28px;"
                                                                            value="{{ isset($textarray[$key])?$textarray[$key]:"" }}">
                                                                    </div>
                                                                    <div class="jFiler-item-assets jFiler-row">
                                                                        <ul class="list-inline pull-right">
                                                                            <li><a class="icon-jfi-trash jFiler-item-trash-action"
                                                                                    onclick="removeuploadedimg('oldVarImgBox{{ $term_item_id }}-{{ $vcnt }}', 'varImage-{{ $term_item_id }}','{{ $v_img }}');"></a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3  .d-xl-block">
                                            <div class="form-group row font-weight-bold">
                                                <label class="col-lg-12 col-form-label" for="">{{ $name_main }}
                                                    Variation</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                            <div class="form-group row">
                                                <label class="col-lg-12 col-form-label" for="varRegularPrice">Regular
                                                    Price</label>
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                            <div class="form-group row">
                                                <label class="col-lg-12 col-form-label" for="varSalePrice">Sale Price
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                            <div class="form-group row">
                                                <label class="col-lg-12 col-form-label" for="stock">Stock <span
                                                        class="text-danger">*</span></label>
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                            <div class="form-group row">
                                                <label class="col-lg-12 col-form-label" for="SKU">SKU <span
                                                        class="text-danger">*</span></label>
                                        ...
                                        <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <input type="hidden" name="Variation{{$term_item_id}}-{{$t}}-{{$tt}}'"
                                                value="{{ $tt }}">
                                            <input type="hidden" name="matrix_no{{ $term_item_id }}"
                                                value="{{ count($variant_terms) }}">
                                            <input type="hidden" name="varVariation{{$term_item_id}}-{{$t}}"
                                                value="{{ $required_variation_ids }}">
                                            <input type="hidden" name="tmpdata[]" value="{{ $required_variation_ids }}">
                                            <input type="hidden" name="slug-{{$term_item_id}}-{{$t}}"
                                                value="{{ str_replace('.', 'p', $slug_name) }}">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <input type="text"
                                                            class="form-control input-default varRegularPrice priRegPrice "
                                                            id="" placeholder="Regular Price"
                                                            name="varRegularPrice-{{$term_item_id}}-{{$t}}"
                                                            value="{{ isset($variant['regular_price']) ? $variant['regular_price'] : '' }}">
                                                        <label id="varRegularPrice-{{$term_item_id}}-{{$t}}-error"
                                                            class="error invalid-feedback animated fadeInDown"
                                                            for="varRegularPrice"></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <input type="text"
                                                            class="form-control input-default varSalePrice priSalePrice "
                                                            placeholder="Sale Price" id=""
                                                            name="varSalePrice-{{$term_item_id}}-{{$t}}"
                                                            value="{{ $variant['sale_price'] }}">
                                                        <label id="varSalePrice-{{$term_item_id}}-{{$t}}-error"
                                                            class="error invalid-feedback animated fadeInDown"
                                                            for="varSalePrice"></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <input type="number" class="form-control input-default stock"
                                                            id="stock" placeholder="Stock"
                                                            name="stock-{{$term_item_id}}-{{$t}}"
                                                            value="{{ $variant['stock'] }}">
                                                        <label id="stock-{{$term_item_id}}-{{$t}}-error"
                                                            class="error invalid-feedback animated fadeInDown"
                                                            for="stock"></label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control input-default SKU " {{
                                                            ($variant['SKU']=="" )?'':'readonly' }} id="SKU"
                                                            placeholder="SKU" name="SKU-{{$term_item_id}}-{{$t}}"
                                                            value="{{ $variant['SKU'] }}">
                                                        <label id="SKU-{{$term_item_id}}-{{$t}}-error"
                                                            class="error invalid-feedback animated fadeInDown"
                                                            for="SKU"></label>
                                            ...
                                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                                <button class=" RemoveBox btn-white"><i
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control input-default ProductName" id="meta_title"
                                    name="meta_title" value="{{ isset($product->meta_title)?$product->meta_title:'' }}">
                            </div>
                            <div class="col-md-6">
                                ...
                                <textarea type="meta_description" class="form-control input-default"
                                    id="meta_description"
                                    name="meta_description">{{ isset($product->meta_description)?$product->meta_description:'' }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card" id="">
            <div class="card-body newcard-body row">
                <div class="col-lg-6 col-sm-6">
                    ...
                    <button type="button" id="saveDraftBtn" name="saveDraftBtn" class="btn btn-outline-primary ">Save As
                        Draft <i class="fa fa-circle-o-notch fa-spin draftloader" style="display:none;"></i></button>
                </div>
