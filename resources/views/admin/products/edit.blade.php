                ...
                <div class="col-lg-9 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" id="attributes_no" name="attributes_no" value="{{ ($attributes_no!="")?$attributes_no:0 }}">
                                    ...
                                    <div class="form-group attribute" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                @else
                                                <button type="button" class="AddSub btn  d-inline-block mb-3" data-id="0" style="background-color: #e7e7e7; color: black;" id="AddSub" style="display: none"> Add </button>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
