                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-12">
                                                    <input type="text" class="form-control input-default SKU " readonly
                                                        id="SKU" placeholder="SKU" name="SKU-{{$term_item_id}}-{{$t}}"
                                                        value="{{ $variant['SKU'] }}">
            ...
            <div class="card-body newcard-body row">
                <div class="col-lg-6 col-sm-6">
                    ...
                    {{-- <button type="button" id="saveDraftBtn" name="saveDraftBtn"
                        class="btn btn-outline-primary mt-4">Save As Draft <i
