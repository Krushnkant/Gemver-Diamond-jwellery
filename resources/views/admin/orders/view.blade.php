                                    ...
                                    <div class="row custom-row">
                                        <div class="col-sm-12 orderinfoBox">
                                            ...
                                            <div class="row custom-row">
                                                ...
                                                <div class="col-sm-8">
                                                    {{ $delivery_address['CustomerName'] != null ? $delivery_address['CustomerName'] : $Order->user->full_name }}
                                                </div>
                                            </div>
                                            <div class="row custom-row">
                                                <div class="col-sm-4">
                                                    ...
                                                    <div class="form-group">
                                                        <select class="form-control" id="order_status" name="order_status">
                                                            ...
                                                            @elseif($Order->order_status == 7 || $Order->order_status == 8)
                                                                <option value="{{ $Order->order_status }}" selected>Cancel
                                                                </option>
                                                            @endif
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="row custom-row tracking"
                                                style="{{ $Order->order_status != 2 ? 'display: none' : '' }}">
                                                <div class="col-sm-4">
                                                    <b>Tracking URL <span class="editorderListGem">:</span></b>
                                                </div>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control input-flat" id="tracking_url"
                                                        name="tracking_url" value="{{ $Order->tracking_url }}"
                                                        placeholder="Enter Tracking URL">
                                                    <label id="tracking_url-error"
                                                        class="error invalid-feedback animated fadeInDown"
                                                        for="tracking_url"></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12" id="shippingAddressBox">
                                    ...
                                    <div class="row custom-row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" class="form-control input-flat" id="CustomerName"
                                                name="CustomerName"
                                                value="{{ $delivery_address['CustomerName'] != null ? $delivery_address['CustomerName'] : $Order->user->full_name }}">
                                            <label id="CustomerName-error"
                                                class="error invalid-feedback animated fadeInDown"
                                    ...
                                    <div class="row custom-row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" class="form-control input-flat" id="CustomerMobile"
                                                name="CustomerMobile"
                                                value="{{ $delivery_address['CustomerMobile'] != null ? $delivery_address['CustomerMobile'] : $Order->user->mobile_no }}">
                                            <label id="CustomerMobile-error"
                                                class="error invalid-feedback animated fadeInDown"
                                                for="CustomerMobile"></label>
                                        </div>
                                    </div>
                                    <div class="row custom-row">
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" class="form-control input-flat" id="DelAddress1"
                                                name="DelAddress1" value="{{ $delivery_address['DelAddress1'] }}">
                                            <label id="DelAddress1-error"
                                                class="error invalid-feedback animated fadeInDown"
                                                for="DelAddress1"></label>
                                        </div>
                                    </div>
                                    <div class="row custom-row">
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" class="form-control input-flat" id="DelAddress2"
                                                name="DelAddress2" value="{{ $delivery_address['DelAddress2'] }}">
                                            <label id="DelAddress2-error"
                                                class="error invalid-feedback animated fadeInDown"
                                    ...
                                    <div class="row custom-row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" class="form-control input-flat" id="City"
                                                name="City" value="{{ $delivery_address['City'] }}">
                                            <label id="City-error" class="error invalid-feedback animated fadeInDown"
                                                for="City"></label>
                                        </div>
                                    </div>
                                    <div class="row custom-row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" class="form-control input-flat" id="State"
                                                name="State" value="{{ $delivery_address['State'] }}">
                                            <label id="State-error" class="error invalid-feedback animated fadeInDown"
                                                for="State"></label>
                                        </div>
                                    </div>
                                    <div class="row custom-row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" class="form-control input-flat" id="Country"
                                                name="Country" value="{{ $delivery_address['Country'] }}">
                                            <label id="Country-error" class="error invalid-feedback animated fadeInDown"
                                                for="Country"></label>
                                        </div>
                                    </div>
                                    <div class="row custom-row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" class="form-control input-flat" id="Pincode"
                                                name="Pincode" value="{{ $delivery_address['Pincode'] }}">
                                            <label id="Pincode-error" class="error invalid-feedback animated fadeInDown"
                                                for="Pincode"></label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    @foreach ($Order->order_item as $order_item)
                                        ...
                                        @endif
                                            ...
                                            @if (isset($item_details['ItemType']) && $item_details['ItemType'] == 0)
                                                <td>
                                                    @if (isset($item_details['ProductImage']))
                                                        <img src="{{ url($item_details['ProductImage']) }}"
                                            ...
                                            @elseif(isset($item_details['ItemType']) && $item_details['ItemType'] == 1)
                                                <td>
                                                    @if (isset($item_details['ProductImage']))
                                                        <img src="{{ $item_details['ProductImage'] }}" width="50px"
                                                            height="50px">
                                                    @endif
                                                </td>
                                            @else
                                                <td>
                                                    @if (isset($item_details['ProductImage']))
                                                        <img src="{{ url($item_details['ProductImage']) }}"
                                                            ...
                                                            src="{{ $item_details['DiamondImage'] }}" width="50px"
                                                            height="50px">
                                                    @endif
                                                </td>
                                            @endif
                                                    ...
                                                    @if (isset($item_details['ProductTitle']))
                                                        ...
                                                        @if (isset($item_details['spe']))
                                                            @foreach ($item_details['spe'] as $listData)
                                                                <span>{{ isset($listData['term']) ? $listData['term'] : '' }}
                                                                    :
                                                                    {{ isset($listData['term_name']) ? $listData['term_name'] : '' }}</span>
                                                            @endforeach
                                                        @endif
                                                    @endif
                                                @else
                ...
                <div class="card">
                    <div class="card-body publishbtnBox">
                        <div class="btn-row">
                            ...
                            {{--                            @else --}}
                            <button type="submit" id="saveOrderBtn" name="saveOrderBtn" class="btn btn-primary">Save
                                Order <i class="fa fa-circle-o-notch fa-spin loadericonfa"
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '.ApproveReturnRequestOrderItemBtn', function() {
            ...
            $("#OrderItemModal").find("#OrderItemSubmit").html(
                'Approve <i class="fa fa-circle-o-notch fa-spin removeloadericonfa" style="display:none;"></i>');
        ...
        $('body').on('click', '.RejectReturnRequestOrderItemBtn', function() {
            ...
            $("#OrderItemModal").find("#OrderItemSubmit").html(
                'Reject <i class="fa fa-circle-o-notch fa-spin removeloadericonfa" style="display:none;"></i>');
            $("#OrderItemModal").find("#OrderItemSubmit").attr('data-id', item_id);
            $("#OrderItemModal").modal('show');
        ...
        $('body').on('click', '.CancelOrderItemBtn', function() {
            ...
            $("#OrderItemModal").find("#OrderItemSubmit").html(
                'Cancel <i class="fa fa-circle-o-notch fa-spin removeloadericonfa" style="display:none;"></i>');
            $("#OrderItemModal").find("#OrderItemSubmit").attr('data-id', item_id);
            $("#OrderItemModal").modal('show');
        ...
        $('body').on('click', '.ReturnRequestOrderItemBtn', function() {
            ...
            $("#OrderItemModal").find("#OrderItemSubmit").html(
                'Return Request <i class="fa fa-circle-o-notch fa-spin removeloadericonfa" style="display:none;"></i>'
                );
            $("#OrderItemModal").find("#OrderItemSubmit").attr('data-id', item_id);
            $("#OrderItemModal").modal('show');
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res['status'] == 200) {
                        ...
                        toastr.success("Order Item Updated", 'Success', {
                            timeOut: 5000
                        });
                    }
