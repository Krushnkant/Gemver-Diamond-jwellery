<form class="form-valide" action="" id="CategoryCreateForm" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control input-flat" id="meta_title" name="meta_title" value="{{ isset($category)?($category->meta_title):'' }}">
    </div>
    ...
    <div class="form-group">
        ...
        <textarea type="text" class="form-control input-default" id="meta_description" name="meta_description">{{ isset($category)?($category->meta_description):'' }}</textarea>
    </div>
