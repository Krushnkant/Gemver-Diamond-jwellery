<form class="form-valide" action="" id="CategoryCreateForm" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group mt-3 mb-3">
            <div class="form-check">
                <label class="form-check-label">
                    <input type="checkbox" name="is_custom" id="is_custom" class="form-check-input primaryBox"
                        value="0">Do you want to add customized product category?</label>
            </div>
        </div>
    ...
    <div class="form-group"  id="attribute_optional_specification">
        ...
        <button type="button" class="btn btn-outline-primary mt-4" id="save_newCategoryBtn" data-action="add">Save & New
            <i class="fa fa-circle-o-notch fa-spin loadericonfa" style="display:none;"></i></button>&nbsp;&nbsp;
        <button type="button" class="btn btn-primary mt-4" id="save_closeCategoryBtn" data-action="add">Save & Close <i
