                    ...
                    <div class="d-flex mb-2 pb-xxl-2">
                        <span class="wire_bangle_price ">$<span class="sale_price">{{
                            ...
                            <sub class="ms-2 wire_bangle_dublicate_price ">$<span class="regular_price"> {{
                                    $Product->product_variant['0']->regular_price }} </span></sub>
                    ...
                    <form action="" class="mb-4 mb-lg-4">
                        ...
                        <div class="wire_bangle_color pb-md-2 wire_bangle_color_img_part">
                            ...
                            <span class="form-check d-inline-block">
                                ...
                                name="AtributeVariant{{ $productvariants->attribute->display_attrname }}" id=""
                                title="{{ $attribute_term->attribute_terms[0]->attrterm_name }}">
                                <img src="{{ url('images/attrTermThumb/'.$attribute_term->attribute_terms[0]->attrterm_thumb) }}"
                                    alt="{{ $attribute_term->attribute_terms[0]->attrterm_name }}"
                                    class="wire_bangle_color_img">
                        ...
                        <div class="row mb-4" id="specificationproduct143">
                            ...
                            <div class="mt-3 wire_bangle_share wire_bangle_share_part row ps-0">
                                <span
                                    class="d-block col-6 col-sm-4 col-md-5 col-xl-8 ps-0 wire_bangle_heading_part_1 mb-3">{{
                                    $product_attribute_specification->display_attrname }}</span>
                                <span class="wire_bangle_color_theme d-block col-6 col-sm-8 col-md-7 col-xl-8 px-0">{{
                        ...
                        <div class=" mt-3 mb-4" id="slick-lightbox">
                            <div class="item">
                                ...
                                <a href="{{ url('images/sizechart_thumb/'.$Product->sizechart_image) }}"
                                    class="size-guide-text mx-4" target="_blank">
                        ...
                        <div class="inquiry_now_btn">
                            <button type="button" id="save_newProductBtn"
                                class="select_setting_btn  btn-hover-effect btn-hover-effect-black diamond-bt">select
                                setting</button>
                            @if($check_diamond == 1)
                            <button id="save_newAddToCartBtn"
                                class="select_setting_btn  btn-hover-effect btn-hover-effect-black diamond-bt">add to
                                cart</button>
                            @endif
                        </div>
            ...
            {{-- <div class="col-md-6 mb-4 ps-0 pe-0 pe-md-3">
                <div class="review_box">
                    ...
                    <div class="review_description_paragraph">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla eligendi expedita enim quae
                        possimus ab magni facilis dicta, illum quas ipsum quis deleniti iusto eum quibusdam et? Ullam,
                        ad dolorum.
                    </div>
                    <div class="review_thumb_part mt-3">
                        <img src="{{ asset('frontend/image/round.png') }}" id="inquiry_image" alt=""
                            class="review_thumb_part_img">
                        <img src="{{ asset('frontend/image/round.png') }}" id="inquiry_image" alt=""
                            class="review_thumb_part_img">
                        <img src="{{ asset('frontend/image/round.png') }}" id="inquiry_image" alt=""
                            class="review_thumb_part_img">
...
<div class="modal fade inquiry_now_modal" id="hintModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable text-center">
        <div class="modal-content">
            <div class="row">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.result == 'data not found') {
                        ...
                        $('.discount_percent').html(data.result.discount_percent);
