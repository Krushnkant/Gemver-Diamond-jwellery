        ...
        <div class="col-lg-8 col-xl-9 px-0 mb-3">
            <div class="blog_tabs">
                ...
                <ul class="nav nav-tabs blog_filter_btn_ul " id="myTab" role="tablist">
                    ...
                    <?php
                    $idName = "myTabContent_" . $key;
                    ?>
                    <li class="nav-item category item">
                        <button class="nav-link common_selector" id="{{$idName}}" data-value="{{ $Category->id }}" data-bs-toggle="tab" role="tab" aria-controls="profile" aria-selected="false">
                ...
                $idName = "myTabContent_" . $key;
                ?>
                <div class="tab-content" id="{{$idName}}">
