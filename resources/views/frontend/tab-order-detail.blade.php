    ...
    <div class="container my-5">
        ...
        <ul class="nav nav-pills my-4 my_account_tab" id="pills-tab" role="tablist">
            <li class="nav-item active" role="presentation">
                <a href="{{ url('/cart') }}" class="" id="order-part-tab" data-bs-toggle="pill" data-bs-target="#order-part" type="button" role="tab" aria-controls="order-part" aria-selected="true">
            ...
            <li class="nav-item" role="presentation">
                <a href="{{ url('/cart') }}"  id="cart-part-tab" data-bs-toggle="pill" data-bs-target="#cart-part" type="button" role="tab" aria-controls="cart-part" aria-selected="false">
            ...
            <li class="nav-item" role="presentation">
                <a href="{{ url('/wishlist') }}"  id="wishlist-part-tab" data-bs-toggle="pill" data-bs-target="#wishlist-part" type="button" role="tab" aria-controls="wishlist-part" aria-selected="false">
            ...
            <li class="nav-item" role="presentation">
                <a href="#"  id="address-part-tab" data-bs-toggle="pill" data-bs-target="#address-part" type="button" role="tab" aria-controls="address-part" aria-selected="false">
            ...
            <li class="nav-item" role="presentation">
                <a href="{{ url('/account') }}" id="account-part-tab" data-bs-toggle="pill" data-bs-target="#account-part" type="button" role="tab" aria-controls="account-part" aria-selected="false">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <li class="nav-item" role="presentation">
                <a href="/frontend/logout"  id="logout-part-tab" data-bs-toggle="pill" data-bs-target="#logout-part" type="button" role="tab" aria-controls="logout-part" aria-selected="false">
                            ...
                            <div class="order-detail-box">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="order-col-part-2 col-9">
                                        ...
                                        150, Bayard, St Staten Island, UK
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="">
                    <div class="table-responsive">
                        <table class="table table_part_view Item_table">
                            ...
                            <tbody>
                                <tr>
                                    <td class="number_part">1.</td>
                                    <td class="table_product_part">
                                        <span class="table_img">
                                            <img src="{{ url('frontend/image/product_name_1.png') }}" alt="">
                                        </span>
                                ...
                                <tr>
                                    <td class="number_part">2.</td>
                                    <td class="table_product_part">
                                        <span class="table_img">
                                            <img src="{{ url('frontend/image/product_name_2.png') }}" alt="">
                                        </span>
                                        <span class="ms-3 cart_product_part">
                                            <div class="cart_product_name">
                                                    Classic His & Her
                                ...
                                <tr>
                                    <td class="number_part">3.</td>
                                    <td class="table_product_part">
                                        <span class="table_img">
                                            <img src="{{ url('frontend/image/product_name_3.png') }}" alt="">
                                        </span>
                                        <span class="ms-3 cart_product_part">
                                            <div class="cart_product_name">
                                                    Classic His & Her
