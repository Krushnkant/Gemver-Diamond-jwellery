...
<div class="background-sub-slider">
    ...
    <div class="container my-5">
        ...
        <ul class="nav nav-pills my-4 my_account_tab" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="account-part-tab" data-bs-toggle="pill" data-bs-target="#account-part" type="button" role="tab" aria-controls="account-part" aria-selected="false">
