...
<div class="background-sub-slider">
    <div class="">
        <div class="about_us_background">
            <h1 class="sub_heading mb-lg-3"> My Account</h1>
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="order-part" role="tabpanel" aria-labelledby="order-part-tab">
            <div class="table-responsive">
                @if(count($orders) > 0)
                <table class="table table_part_view mt-xxl-5">
                    <thead>
                        <tr>
                            <th scope="col">No.</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="address_table_part">
                                <button type="button" class="btn btn-primary edit-button viewOrderBtn "
                                    data-id="{{ $order->id }}">View</button>
                                @if($order->order_status == 1)
                                <button type="button" class="btn btn-danger edit-button CancelRequestBtn"
                                    data-id="{{ $order->id }}">Cancel</button>
                                @endif
                                @if($order->order_status == 3)
                                {{-- <button type="button" class="btn btn-danger edit-button ReturnRequestBtn"
                                    data-id="{{ $order->id }}">Return Request</button> --}}
                                <button id="ReturnRequestBtn" class="btn btn-danger edit-button text-white btn-sm"
                ...
                <div class="row">
                    <div class="col-md-12 mycard py-5 text-center">
                        <div class="mycards">
                            <h4>Your orders is currently empty.</h4>
                        </div>
                    </div>
                </div>
                @endif
                ...
                <form id="ReturnRequestForm" method="post">
                    <div class="row mb-3 mb-md-4">
                        <div class="col-md-12 mb-3 mb-md-0 popup_padding">
                            <label class="col-form-label" for="order_action_reason">Reason<span
                                    class="text-danger">*</span>
                            </label>
                            <input type="text" class="form-control input-flat" id="order_action_reason"
                                name="order_action_reason" placeholder="">
                            <div id="order_action_reason-error" class="invalid-feedback animated fadeInDown"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="file" class="form-control input-flat" id="order_return_imgs"
                                name="order_return_imgs[]" placeholder="" multiple>
                            <div id="order_return_imgs-error" class="invalid-feedback animated fadeInDown"
                                style="display: none;"></div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3 mb-md-0">
                            ...
                            <input type="file" class="form-control input-flat" id="order_return_video"
                                name="order_return_video" placeholder="">
                            <div id="order_return_video-error" class="invalid-feedback animated fadeInDown"
                                style="display: none;"></div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="AddReturnRequestBtn" class="btn btn-primary chnage_address_btn">Submit
