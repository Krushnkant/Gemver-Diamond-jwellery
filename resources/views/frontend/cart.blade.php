...
@section('content')
    ...
    <div class="container ">
                    ...
                    <div class="col-lg-4 px-md-3">
                        <div class="order_summary_box ms-0">
                            ...
                            <div class="order_summary_proceed_checkout">
                                ...
                                <button type="button" class="btn btn-dark w-100 proceed_to_checkout_btn mt-2"  data-bs-toggle="modal" data-bs-target="#exampleModalCart">inquiry now</button>
                            </div>
                        </div>
                    </div> 
                @endif
        ...
        @endif
        <div class="modal fade inquiry_now_modal" id="exampleModalCart" aria-labelledby="exampleModalLabelCart" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable text-center">
                                    <div class="modal-content p-3 p-md-4">
                                        ...
                                        <div class="row mb-4 mb-xxl-4">
                                            ...
                                            <button type="button" class="send_inquiry_btn product_detail_inquiry_btn" id="save_newInquiryBtnCart" >send inquiry 
                                            <div class="spinner-border loadericonfa spinner-border-send-inquiry" role="status" style="display:none;">
                                                <span class="visually-hidden">Loading...</span>
                                            </div>
                                           </button>
