    ...
    <div class="container ">
        @if (session()->has('customer'))
            ...
            <ul class="nav nav-pills my-4 my_account_tab" id="pills-tab" role="tablist">
                ...
                <li class="nav-item " role="presentation">
                    <a href="{{ url('/account') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 46 50"
                            fill="none">
                            <path
                                                ...
                                                <tr class="cartpage">
                                                    <td class="cart-product-name-info1">
                                                        <input type="hidden" class="variant_id"
                                                            value="{{ $data['item_id'] }}">
                                                        <input type="hidden" class="diamond_id"
                                                            value="{{ $data['diamond_id'] }}">
                                                        <input type="hidden" class="item_type"
                                                            value="{{ $data['item_type'] }}">

                                                        <div class="row">

                                                            <div class="col-md-2 col-4 text-center">
                                                                <img src="{{ asset($item_image[0]) }}"
                                                                    alt="{!! $item_name !!}" class="cart-item-img">
                                                            </div>
                                                            <div class="col-md-10 col-8 p-0">
                                                                <div class="row">
                                                                    <div class="col-md-7 col-sm-12">
                                                                        <div class="">
                                                                            <a href="{{ $url }}"
                                                                                class="cart_product_name mb-2">{!! $item_name !!}</a>
                                                                        </div>
                                                                        ...
                                                                        @if (isset($data['item_type']) && $data['item_type'] != 1)
                                                                            ...
                                                                            ?>
                                                                            <div
                                                                                class="cart_product_specification d-block mt-1">
                                                        ...
                                                        @if ($data['item_type'] == 2)
                                                            <div class="row mt-4">
                                                                ...
                                                                <div class="col-md-10 col-8">
                                                                    <div class="">
                                                                        <a href="{{ $url }}"
                                                                            class="cart_product_name mb-2">{!! $diamond_name !!}</a>
                                                                    </div>
                                                    ...
                                                    <td class="total_amount">
                                                        <i class="fa fa-usd" aria-hidden="true"></i><span
                                                            class="cart-total-price ">{{ $sale_price * (int) $data['item_quantity'] + $certificate_price }}</span>
                                                    </td>
                                                </tr>
                                                <?php
                                                $total = $total + $sale_price * $data['item_quantity'] + $certificate_price;
                                ...
                                @foreach ($BlogBanners as $key => $BlogBanner)
                                    ...
                                    @if (count($BlogBanners) > 1)
                                        <div class="col-sm-6 col-lg-6 ">
                                            <div class="mt-4">
                                                <a href="{{ $url }}"><img
                                                        src="{{ url($BlogBanner['banner_thumb']) }}" alt=""></a>
                                            </div>
                                        </div>
                                    @else
                    ...
                    <div class="col-lg-4 px-md-3">
                        <div class="order_summary_box ms-0">
                            <div class="row order_summary_input_part offer-label-box align-items-center mt-4">
                                <div class="col-1 p-0">
                                    <img src="{{ asset('frontend/image/discount-tag.png') }}" alt=""
                                        class="">
                                </div>
                                <div class="col-8">
                                ...
                                <div class="col-3 text-end order_summary_price ">
                                    <a class="mb-2" href="javascript:void(0)" data-bs-toggle="modal"
                                        data-bs-target="#exampleModalOffer">Offers <i
                                            class="fa-solid fa-chevron-right"></i></a>
                                </div>
                                <div class="modal fade inquiry_now_modal" id="exampleModalOffer"
                                    aria-labelledby="exampleModalLabelOffer" aria-hidden="true">
                                            ...
                                            <div class="row align-items-center mb-4">
                                                <div class="col-9 col-sm-9 ps-0">
                                                    <input type="text" placeholder="Enter your code"
                                                        class="enter_yout_code_input" name="coupon_code"
                                                        id="coupon_code">
                                                    <div id="coupon_code-error"
                                                    ...
                                                    <div class="offer-details-box">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            ...
                                                            <div class="apply-coupon-box">
                                                                <button type="button"
                                                                    class="btn btn-outline-primary redeemoffer"
                                                                    data-code="{{ $coupon->coupon_code }}">Apply <span
                                                                        class="spinner-border loadericonfa spinner-border-send-inquiry"
                                                                        role="status"
                                                        ...
                                                        <span class="disc-text d-block mt-2">
                                                            @if ($coupon->discount_type_id == 1)
                                                                {{ $coupon->coupon_amount }} <i class="fa fa-percent"
                            ...
                            <div class="order_summary_proceed_checkout">
                                ...
                                <div class="row mt-3">
                                    ...
                                    ?>
                                    <input type="hidden" id="coupan_discount_amount"
                                        value="{{ $coupan_discount_amount }}">
                                    <div class="col-6 text-end order_summary_price ">
                                        $<span
                                            class="cart-maintotal-price coupan_discount_amount">{{ $coupan_discount_amount }}</span>
                                    </div>
                                </div>
                                @php
                                    $withDiscountAmount = $total - $coupan_discount_amount;
                                    $minOrderAmount = isset($setting->min_order_amount_for_free_shipping)
                                        ? $setting->min_order_amount_for_free_shipping
                                        : 0;
                                    $defaultShipping = isset($setting->default_shipping_amount)
                                        ? $setting->default_shipping_amount
                                        : 0;
                                ...
                                <div class="py-3 py-md-4 mt-4 order-payment-methohs">
                                    ...
                                    <div class="accepted_payment_methods_icon mt-3">
                                        <img src="{{ asset('frontend/image/payment_method.png') }}" alt=""
                                            class="">
                                    </div>
                                </div>
                                @if ($setting->max_order_price > $total - $coupan_discount_amount)
                                    <button type="button"
                                        class="btn btn-dark w-100 proceed_to_checkout_btn check_max_amounty"
