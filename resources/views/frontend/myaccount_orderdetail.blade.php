                    ...
                    <div>
                        ...
                        <div class="order-detail-box">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="order-col-part-2 col-9">
                                    {{ $delivery_address['DelAddress1'] }}, {{ $delivery_address['City'] }}, {{
                                ...
                                <td class="table_product_part">
                                    ...
                                    <span class="ms-3 cart_product_part">
                                        <div class="cart_product_name">
                                            ...
                                            - <a href="javascript:void(0)" id="addReviewBtn"
                                                data-type="{{ $item_details['ItemType'] }}" order-id="{{ $items->id }}"
                                                data-id="{{ $item_details['variantId'] }}" data-bs-toggle="modal"
                                                data-bs-target="#addReviewModel">Add Review</a>
                                            @endif
                                        </div>
                                        <?php
                                                $atr = 0;
...
<div class="modal fade inquiry_now_modal" id="addReviewModel" tabindex="-1" aria-labelledby="addReviewModelLabel"
    aria-hidden="true">
                ...
                <form action="" method="post" id="AddReviewForm" name="AddReviewForm" class="px-0">
                    ...
                    <div class="row mb-4 mb-xxl-4">
                        ...
                        <div class="mb-3 col-md-12 ps-0">
                            ...
                            <input type="text" name="reviewText" id="reviewText" placeholder="Review"
                                class="d-block wire_bangle_input">
                            <div id="reviewText-error" class="invalid-feedback animated fadeInDown text-start"
                                style="display: none;"></div>
                        </div>

                        <div class="mb-3 col-md-6 ps-0">
                            <div class="form-group ">
                                <input type="file" class="form-control-file" id="review_pic" name="review_pic[]"
                                    multiple>
                                <div id="review_pic-error" class="invalid-feedback animated fadeInDown"
                                    style="display: none;"></div>
                            </div>
                        </div>
                    </div>
                    <button type="button" class="send_inquiry_btn product_detail_inquiry_btn newReviewBtn"
                        id="save_newInquiryBtn">Add
