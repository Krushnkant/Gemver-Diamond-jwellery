...
<body>
                            ...
                            <div class="">
                                <picture>
                                    <source media="(max-width:767px)"
                                        srcset="{{ asset('images/categoryThumb_5262271675507815.webp') }}"
                                        type="image/webp">
                                    <img src="{{ asset('images/categoryThumb_5262271675507815.webp') }}"
    ...
    ?>
                    ...
                    <div class="row text-center py-5 align-items-center">
                        <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                            <div class="shop-colorful-img">
                                ...
                                <picture>
                                    <source media="(max-width:767px)" srcset="{{ asset('images/diamond-part.webp') }}"
                                        type="image/webp">
                        ...
                        <div
                            class="col-12 col-md-6 col-lg-6 col-xl-7 offset-xl-1 text-center text-md-start pt-5 pt-md-0">
                            <h2 class="heading-h2 mb-0 text-center text-md-start">{{ number_format($diamonds) }}
                                Diamonds available <br> in the Store</h2>
                            <div class="sub_title text-center text-md-start">
                                Glide with the shine of beautiful Jewels
                            </div>
                            <div class="shop-colorful-bg-btn-div">
                                <a href="{{ url('/lab-diamond') }}" class="shopnow_diamond">Shop Now <i
                    ...
                    ?>
                        <div class="hover_effect_part wire_bangle_shop_radio product-data">
                            <div class="wire_bangle_img_radio_button">
                                ...
                                ?>
                                        ...
                                        {{-- <video loop="true" autoplay="autoplay" muted
                                            style="width:100%; height:200px;" name="media">
                                ...
                                $ProductVariantVariant = \App\Models\ProductVariantVariant::select('slug','attrterm_thumb','attrterm_name')->leftJoin("attribute_terms",function($join){
                                    ...
                                    if(count($ProductVariantVariant) > 0){
                                        ?>
                                    <span
                                        class="wire_bangle_color wire_bangle_color_img_part text-center wire_bangle_color_ring_part">
                            ...
                            ?>
                                    ...
                                    <div class="wire_bangle_sub_heading wire_bangle_description"><a href="{{ $url }}">{{
                                    ...
                                    <div class="d-flex justify-content-between  align-items-center">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span
                                                class="ms-2 wire_bangle_dublicate_price product_detail_regular_price">$<span
                                                    class="regular_price">{{ $product->regular_price }}</span></span>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="shop_dimond_by_shape">
                    <div class="mb-4 mb-md-0 pb-md-5 text-center ">
                        <h2 class="heading-h2 shop_diamond_by_shape_heading">{{ $homesetting->section_diamond_title }}
                        </h2>
                        ...
                        <div class="owl-carousel owl-theme shop-dimond-by-shape-slider">
                            <div class="item">
                                <a href="{{ url('/lab-diamond/round') }}" class="shop-dimond-by-shape-img">
                                    ...
                                    <picture>
                                        <source media="(max-width:767px)" srcset="{{ asset('images/webp/round.webp') }}"
                                            type="image/webp">
                            ...
                            <div class="item">
                                <a href="{{ url('/lab-diamond/oval') }}" class="shop-dimond-by-shape-img">
                                    ...
                                    <picture>
                                        <source media="(max-width:767px)" srcset="{{ asset('images/webp/oval.webp') }}"
                                            type="image/webp">
                            ...
                            <div class="item">
                                <a href="{{ url('/lab-diamond/cushion') }}" class="shop-dimond-by-shape-img">
                                    ...
                                    <picture>
                                        <source media="(max-width:767px)"
                                            srcset="{{ asset('images/webp/cushion.webp') }}" type="image/webp">
                            ...
                            <div class="item">
                                <a href="{{ url('/lab-diamond/marquise') }}" class="shop-dimond-by-shape-img">
                                    ...
                                    <picture>
                                        <source media="(max-width:767px)"
                                            srcset="{{ asset('images/webp/marquise.webp') }}" type="image/webp">
                            ...
                            <div class="item">
                                <a href="{{ url('/lab-diamond/pear') }}" class="shop-dimond-by-shape-img">
                                    ...
                                    <picture>
                                        <source media="(max-width:767px)" srcset="{{ asset('images/webp/pear.webp') }}"
                                            type="image/webp">
                            ...
                            <div class="item">
                                <a href="{{ url('/lab-diamond/radiant') }}" class="shop-dimond-by-shape-img">
                                    ...
                                    <picture>
                                        <source media="(max-width:767px)"
                                            srcset="{{ asset('images/webp/radiant.webp') }}" type="image/webp">
                    ...
                    <div class="col-lg-7 col-xl-8 col-md-7 col-sm-7 mt-4 mt-sm-0 mt-md-0 mt-lg-0">
                        ...
                        <div class="row">
                            <div
                                ...
                                <div>
                                    <p
                                        class="customer_stories_paragraph engagement_diamond_paragraph ms-3 ms-lg-0 mb-0">
                                        {{ $step->step1_shotline }}
                                    </p>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-6 px-4 engagement_ring_col_part px-0 mt-md-0 py-4 order-2 order-md-1">
                    <div class="engagement_ring_diamond_part">
                        ...
                        <div class="customer_stories_paragraph  mb-3 mb-lg-4">{{
                            $homesetting->section_customise_description }}</div>
                        <a style="" class="explore-category-btn buy_lab_diamonds_btn black_hover_btn"
                            href="{{ url('shop/'.$homesetting->slug) }}"> {{ $homesetting->section_customise_label
                            }}</a>
                    </div>
                </div>
                <div class="col-md-6 pe-0 px-0 order-1 order-md-2">
                    <div class="own_ring_img">
                        {{-- <img src="{{ url('images/webp/categoryThumb_3284881676018051.webp') }}" alt="" width="100%"
                            loading="lazy"> --}}
                        <picture>
                            <source media="(max-width:767px)"
                                srcset="{{ asset('images/webp/categoryThumb_3284881676018051.webp') }}"
                                type="image/webp">
                            <img src="{{ asset('images/webp/categoryThumb_3284881676018051.webp') }}" alt=""
                                loading="lazy">
                        </picture>
                    </div>
                </div>
        ...
        <div class="smiling_gemver_banner">
            <div class="container">
                <h2 class="mb-4 mb-md-5 heading-h2 text-center smiling_gemver_heading">{{
                    $homesetting->section_smiling_difference_title }}</h2>
                <div class="row">
                ...
                <div class="mt-3 text-center">
                    <a class="explore-category-btn btn-hover-effect btn-hover-effect-black diamond-btn buy_lab_diamonds_btn mt-md-4"
                        href="{{ url('gemver-difference') }}">{{ $homesetting->section_smiling_difference_title }}</a>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-{{ $blogcol }} col-sm-12 banner_part">
                        <a href="{{ $url }}" class="banner_part_img_parent">
                            <figure>
                                {{-- <img class="" src="{{ url('images/webp/categoryThumb_4798191674619313.webp') }}"
                                    alt="" loading="lazy"> --}}
                                <picture>
                                    <source media="(max-width:767px)"
                                        srcset="{{ asset('images/webp/categoryThumb_4798191674619313.webp') }}"
                                        type="image/webp">
                                    <img src="{{ asset('images/webp/categoryThumb_4798191674619313.webp') }}" alt=""
                                        loading="lazy">
                                </picture>
                            </figure>
                        </a>
                ...
                <div class="customer_stories">
                    <div class="row">
                        <div class="col-lg-5 customer_stories_bg">
                            <div class="">
                                <h2 class="heading-h2 text-white heading-h2-yellow-color text-center text-lg-start">{{
                                    $homesetting->section_stories_title }}</h2>
                                <div class="customer_stories_paragraph mb-3 mb-lg-0 text-center text-lg-start mb-3">{{
                                    $homesetting->section_stories_description }}</div>
        ...
        <div class="container">
            <div class="gemver_diamonds_section px-0">
                <div class="px-3">
                    <h2 class="heading-h2 text-white heading-h2-yellow-color text-center text-md-start">{{
                        $homesetting->section_why_gemver_title }}</h2>
                    <div class="customer_stories_paragraph mb-3 mb-md-5 text-center text-md-start">{{
                        $homesetting->section_why_gemver_description }}</div>
                </div>
                <div class="row">
                    <div class="col-md-6 mt-md-0 px-0 ps-md-3 position-relative order-2 order-md-1">
                        <div class="gemver_diamods_bg">
                            <div class="diamonds_part">
                                ...
                                <button type="button"
                                    data-value='{{ ($homesetting->section_why_gemver_button_url1) ? $homesetting->section_why_gemver_button_url1 : "#" }}'
                                    class="explore-category-btn btn-hover-effect btn-hover-effect-black inquiry_btn_gemver_diamonds customize-button-url">{{
                                    $homesetting->section_why_gemver_button_title1 }}</button>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <form action="" method="post" id="InquiryCreateForm"
                                                ...
                                                <div class="row mb-4 mb-xxl-4">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <select class="d-block wire_bangle_input form-control"
                                                                    ...
                                                                    <option value=""></option>
                                                                    <option data-countryCode="GB" value="44">Norway
                                                                        (+47)</option>
                                                    ...
                                                    <div class="mb-3 col-md-6 ps-0">
                                                        <div class="input-group ">
                                                            <div class="input-group-prepend">
                                                                <select class="" name="country_code_whatsapp"
