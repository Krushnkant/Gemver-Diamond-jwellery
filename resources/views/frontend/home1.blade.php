                        ...
                        <a href="{{ URL('/shop/'.$category->slug)}}">
                            <div class="catrgery_box">
                                <span class="catrgory_img">
                                    <img src="https://d24ppbhzdyfrur.cloudfront.net/uploads/image_url/s3_image/6393428/Sample_RD_HI-SI.jpg" alt="{{ $category->category_name }}">
                                </span>
                    ...
                    <div class="wire_bangle_img_radio_button">
                        <div class="wire_bangle_img position-relative">
                            <a class="wire_bangle_hover_a" href="{{ $url }}">
                                ...
                                <img src="https://d24ppbhzdyfrur.cloudfront.net/uploads/image_url/s3_image/6393428/Sample_RD_HI-SI.jpg" alt="{{ $alt_text }}">
                                <?php }else{ ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6 pe-0 px-0 order-1 order-md-2">
                <div class="own_ring_img">
                    <img src="https://d24ppbhzdyfrur.cloudfront.net/uploads/image_url/s3_image/6393428/Sample_RD_HI-SI.jpg" alt="" width="100%">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-{{ $blogcol }} col-sm-12 banner_part">
                        <a href="{{ $url }}" class="banner_part_img_parent">
                            <figure>
                                <img class="" src="https://d24ppbhzdyfrur.cloudfront.net/uploads/image_url/s3_image/6393428/Sample_RD_HI-SI.jpg" alt="">
                            </figure>
                        </a>
                    </div>
                    @endforeach 
