    ...
    <div class="container my-5">
        ...
        <ul class="nav nav-pills my-4 my_account_tab" id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="order-part-tab" data-bs-toggle="pill" data-bs-target="#order-part" type="button" role="tab" aria-controls="order-part" aria-selected="true">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="wishlist-part-tab" data-bs-toggle="pill" data-bs-target="#wishlist-part" type="button" role="tab" aria-controls="wishlist-part" aria-selected="false">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="address-part-tab" data-bs-toggle="pill" data-bs-target="#address-part" type="button" role="tab" aria-controls="address-part" aria-selected="false">
        ...
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade" id="order-part" role="tabpanel" aria-labelledby="order-part-tab">
                1
            </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="address_table_part">
                                        ...
                                        <div>
                                            Krushnkant.Vadadoriya@gmail.com
                                        </div>
                                        <div>
                                            9856234589
                                        </div>
                                    ...
                                    <td class="action-button">
                                        ...
                                        <button type="button" class="btn btn-secondary delete-button ms-2">Delete</button>
                                    </td>
                                </tr>
                                <tr>
