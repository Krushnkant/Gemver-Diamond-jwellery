...
class ImportDiamond implements WithHeadingRow,ToCollection
{
    ...
    */
    public function collection(Collection $collections)
    {
        ...
        {
            if((int)$collection['final_price'] > 0 && $collection['final_price'] != ""){
            ...
            // $company_per = $Company->company_percentage;
                ...
                if($Diamond){
                    ...
                    $data = ([
                        ...
                        'meas_length' => $collection['meas_length'],
                        'meas_width' => $collection['meas_width'],
                        'meas_depth' => $collection['meas_depth'],
