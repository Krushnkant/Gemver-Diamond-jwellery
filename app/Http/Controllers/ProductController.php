...
class ProductController extends Controller
{
    ...
    public function product_detail($variantslug)
    {
        ...
        return view('frontend.product',compact('Product','variantid','attribute_term_ids','ProductRelated','OrderIncludes','settings','primary_category_idss'))->with(['meta_title'=>$meta_title,'meta_description'=>$meta_description]);
    }
