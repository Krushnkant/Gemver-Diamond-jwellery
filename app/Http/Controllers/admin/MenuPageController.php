...
class MenuPageController extends Controller
{
    ...
    public function engagementpage()
    {
        ...
        return view('admin.menupage.engagementpage',compact('menupages','categories'))->with('page',$this->page);
    }
    ...
    public function weddingpage()
    {
        ...
        $categories = Category::where(['estatus' => 1,'is_custom' =>0])->orderBy('created_at','DESC')->get();
        return view('admin.menupage.weddingpage',compact('menupages','categories'))->with('page',$this->page);
    }
    ...
    public function growndiamondpage()
    {
        ...
        $categories = Category::where(['estatus' => 1,'is_custom' =>0])->orderBy('created_at','DESC')->get();
        return view('admin.menupage.growndiamondpage',compact('menupages','categories'))->with('page',$this->page);
    }
