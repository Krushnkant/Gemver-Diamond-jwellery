...
class HomeController extends Controller {
    public function index() {
        ...
        return view('frontend.home', compact('categories', 'testimonials', 'banners', 'step', 'homesetting', 'shopbystyle', 'products', 'BlogBanners', 'SmilingDifference', 'diamonds', 'contents', 'CountryCodeJson'));
    }
